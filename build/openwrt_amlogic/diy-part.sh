...
cat >$NETIP <<-EOF
uci set network.lan.ipaddr='192.168.6.128'                      # IPv4 地址(openwrt后台地址)
...
uci set network.lan.dns='192.168.6.1 223.5.5.5 114.114.114.114'          # 旁路由设置 DNS(多个DNS要用空格分开)（去掉uci前面的#生效）
